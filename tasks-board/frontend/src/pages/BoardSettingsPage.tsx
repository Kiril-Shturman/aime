...
// Настройки досочно-ботовой части: доступ к доске, DM-аккаунт, режим
// бота в личке, автоответ, слежение за правками, сводка, заготовки.
// Вынесено сюда, чтобы главный /profile не был перегружен.
  ...
  return (
    <Page className="pb-safe-20 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
      <Navbar
        ...
        left={
          <NavbarBackLink text="Профиль" onClick={() => navigate('/profile')} />
        }
      />
